...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0E14] text-white font-sans flex flex-col">
      {/* Top Navigation */}
      <nav className="h-16 px-8 flex items-center justify-between border-b border-white/5">
        ...
        <button className="px-5 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-sm font-semibold transition-all shadow-lg shadow-blue-600/20 active:scale-95">
          Get Started
        </button>
      </nav>
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-16 relative">
        ...
        >
          <div className="bg-[#151921]/80 backdrop-blur-xl border border-white/5 rounded-2xl p-8 shadow-2xl shadow-black/20">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[#0B0E14] border border-white/10 rounded-xl py-3.5 pl-11 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500/30 transition-all placeholder:text-slate-600"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[#0B0E14] border border-white/10 rounded-xl py-3.5 pl-11 pr-12 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500/30 transition-all placeholder:text-slate-600"
                  />
                  <button
                    type="button"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full bg-blue-600 hover:bg-blue-500 text-white py-3.5 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all shadow-lg shadow-blue-600/20"
              >
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2.5 py-3 bg-white/5 hover:bg-white/10 border border-white/5 rounded-xl text-sm font-semibold transition-all">
