...
export const getTeamMembers = () => request('/users/team');
...
// AMAZON NOVA AI
export const analyzeLeadAI = (payload) =>
  request('/ai/lead-analysis', { method: 'POST', body: JSON.stringify(payload) });

export const generateEmailAI = (payload) =>
  request('/ai/generate-email', { method: 'POST', body: JSON.stringify(payload) });

export const summarizeNotesAI = (payload) =>
  request('/ai/summarize-notes', { method: 'POST', body: JSON.stringify(payload) });
