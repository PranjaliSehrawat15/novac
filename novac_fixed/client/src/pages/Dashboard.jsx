  ...
  return (
    <div className="glow-bg min-h-screen" style={{ background:'var(--bg-canvas)', color:'var(--text-primary)' }}>
      ...
      <main className="max-w-[1400px] mx-auto px-6 py-8">
        ...
        {summary && (
          <div className="grid grid-cols-1 xl:grid-cols-[1.5fr,1fr] gap-5">
            ...
            <motion.div initial={{ opacity:0, y:16 }} animate={{ opacity:1, y:0 }} transition={{ delay:0.46 }}><NovaAssistantWidget /></motion.div>
          </div>
        )}
      </main>
    </div>
